...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 09:07:15 GMT -->
<head>
    <meta charset="utf-8">
...
<body id="app" class="sticky-header newsletter-popup-modal">
                            ...
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="single-product.html/{{$item->id}}">
                                        <img height="320" data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800" loading="lazy" src="{{$item->image_name}}" alt="{{$item->name}}">
                                        <img height="320" class="hover-img" src="{{$item->image_name}}" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="quickview"><a href="{{$item->name}}/{{$item->id}}" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                                            <li class="select-option"><a href="single-product.html">Select Product</a></li>
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <div class="product-price-variant">
                                            <span class="price current-price">{{$item->sale_price}}</span>
                                        ...
                                        <div class="color-variant-wrapper">
                                            ...
                                            <add-to-cart @change-cart="cartchange" product-id="{{$item->id}}"
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 09:08:20 GMT -->
</html>
<script>
    import Cart
    export default {
