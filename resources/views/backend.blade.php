...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 09:11:12 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>eTrade || BackEnd</title>
...
<!--           dashboard board tab panel         -->
                    <div class="col-xl-9 col-md-8">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
<example-component user="{{$user}}"/>
                            </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 09:11:13 GMT -->
</html>
<script>
    import UserOrders from "../js/components/userOrders";
    export default {
